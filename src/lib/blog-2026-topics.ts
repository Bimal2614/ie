...
export const TOPIC_POSTS_2026: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How long do I have to request an Enquiry on Results?", a: "Normally six weeks from your test date. The re-mark is carried out by a senior examiner and typically takes a few weeks to return. Check your centre's stated deadline, since it is the one that applies to you." },
    ],
  },
];
